 ...
 * Fix bug in getTransliteration function  [#1](https://github.com/JBZoo/Zoo-Hacks/blob/master/zoo-patch/media/zoo/applications/jbuniversal/framework/helpers-std/string.php#L68)
